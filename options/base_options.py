...
class BaseOptions():
    ...
    def initialize(self, parser):
        # base define
        parser.add_argument('--name', type=str, default='aid', help='name of the experiment.')
        ...
        parser.add_argument('--img_file', type=str, default='/home/hwl/hwl/datasets/remote-sense-data/AID/AID_dataset/AID_test_500/', help='training and testing dataset')
        parser.add_argument('--mask_file', type=str, default='/home/hwl/hwl/datasets/mask/testing_mask_dataset/0.1', help='load test mask')
